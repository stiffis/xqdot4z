...
**Archivo histórico del proyecto docente kirky-arqui, no guía del core actual.**
La derivación de investigación se llama **Kuntur** y está en
`/home/stiff/stuff/xqdot4z/kuntur/`. Sus instrucciones actuales están en
[el README del core](../../README.md) y [el registro de correcciones](../CORE_CORRECTIONS.md).
Las rutas, convenciones de trabajo y conteos inferiores describen la entrega
original; no deben usarse para modificar el original desde esta investigación.
