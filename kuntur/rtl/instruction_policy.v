...
module instruction_policy #(parameter ENABLE_XQDOT4Z = 0, parameter ENABLE_MUL = 0,
                            parameter ENABLE_XQDOT4 = 0)(input [31:0] instr,
  ...
  always @* begin
    ...
    case (op)
      ...
      7'b0101011: begin // custom-1: xqdot4, no zero-point field
        supported = (ENABLE_XQDOT4 != 0) && (f3 == 0) &&
                    (instr[31:28] == 0) && (instr[26:25] == 0);
        uses_rs1 = supported; uses_rs2 = supported;
      end
      ...
      7'b0110011: begin
        case (f3)
          3'b000: supported = (f7 == 0 || f7 == 7'b0100000 ||
                              ((ENABLE_MUL != 0) && f7 == 7'b0000001));
