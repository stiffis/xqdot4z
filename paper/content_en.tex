...
Against scalar MUL, D uses between 5.4 and 6.8 times fewer cycles at $N{=}16$,
the low end at $z{=}0$ where D has no correction to save; B1, without a
multiplier, spends between 26 and 34 times more than D. That forced
...
a new encoding, but still has no implementation or measured cost. The counters
are validated structurally, against eight directed programs, three negative
controls, four detected harness mutations and a cycle accounting identity
checked per case; RTL cycles still do not establish physical timing. The
sensitivity question is answered for the row count alone: one group of 32
elements was measured, so how the comparison moves with K and G is open, and
the frozen data layout does not currently reach those shapes.
