...
against a structural oracle, and all four variants return the same integers as
the oracle and as each other. The comparison conditions remain to be settled
before measurement.
