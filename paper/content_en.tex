...
unproven. The measurement window and its counters are now fixed and verified
against a structural oracle, and the D and B3 kernels return the same integers
as the oracle and as each other; B1, B2 and the comparison conditions remain to
be settled before measurement.
