...
\section{Conclusion}
\textit{Evaluation pending.} Whether fusion improves performance remains
unproven. Comparison conditions will be finalized, and kernels and
instrumentation verified, before measurement.
