...
Las fuentes, la evidencia y ambos manuscritos están disponibles en
\url{https://github.com/stiffis/xqdot4z}, etiquetados en la revisión de la que
salieron estas cifras; \texttt{make check} vuelve a derivar todos los hashes
citados aquí sin re-simular, y \texttt{make campaign} reproduce las mediciones
desde cero. El código está bajo licencia MIT.
