module datapath #(parameter ENABLE_XQDOT4Z = 0)(input  clk, reset,
  ...
  instruction_policy #(.ENABLE_XQDOT4Z(ENABLE_XQDOT4Z)) policy(
  ...
  assign ExecuteResultE = QDotE ? QDotResultE : ALUResultE;
