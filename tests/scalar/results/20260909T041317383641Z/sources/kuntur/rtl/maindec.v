module maindec(input  [6:0] op,
  ...
  always @* case(op)
    // RegWrite_ImmSrc_ALUSrc_MemWrite_ResultSrc_Branch_ALUOp_Jump_Jalr
      ...
      // Custom arithmetic writes the ordinary result path. instruction_policy
      // gates disabled/reserved encodings before these controls enter E.
      7'b0001011: controls = 12'b1_00_0_0_00_0_00_0_0; // xqdot4zi
      7'b0101011: controls = 12'b1_00_0_0_00_0_00_0_0; // xqdot4
