module riscvpipe #(parameter ENABLE_XQDOT4Z = 0, parameter ENABLE_MUL = 0,
  ...
  datapath #(.ENABLE_XQDOT4Z(ENABLE_XQDOT4Z), .ENABLE_MUL(ENABLE_MUL),
             .ENABLE_XQDOT4(ENABLE_XQDOT4)) dp(
    .clk(clk),
    .reset(reset),
    .ResultSrcW(ResultSrcW),
    .ResultSrcM(ResultSrcM),
