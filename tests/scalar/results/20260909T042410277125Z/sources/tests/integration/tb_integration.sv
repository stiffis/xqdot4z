...
module tb_integration;
  ...
  top #(.IMEM_WORDS(8192), .DMEM_WORDS(64), .IMEM_FILE(""), .CHECKS(0),
        .ENABLE_XQDOT4Z(ENABLE), .ENABLE_MUL(ENABLE_MUL),
  ...
  always @(negedge clk) if (!reset) begin
    if ((dut.rvpipe.dp.QDotE && dut.rvpipe.dp.PackedE) ||
        (dut.rvpipe.dp.QDotE && dut.rvpipe.dp.MulE) ||
        (dut.rvpipe.dp.PackedE && dut.rvpipe.dp.MulE))
      $fatal(1,"M3_FAIL conflicting execution selectors");
    ...
    if (dut.rvpipe.dp.ValidE && dut.rvpipe.dp.MulE)
      $display("MEXEC|%08h|%h|%h|%0d|%0d",dut.rvpipe.dp.PCE,
               dut.rvpipe.dp.SrcAE,dut.rvpipe.dp.WriteDataE,
               dut.rvpipe.ForwardAE,dut.rvpipe.ForwardBE);
    if (dut.rvpipe.dp.ValidE && dut.rvpipe.dp.PackedE)
      $display("PEXEC|%08h|%h|%h|%h|%0d|%0d",dut.rvpipe.dp.PCE,
               dut.rvpipe.dp.SrcAE,dut.rvpipe.dp.WriteDataE,dut.rvpipe.dp.PackedHalfE,
               dut.rvpipe.ForwardAE,dut.rvpipe.ForwardBE);
  end
  // Interrupt custom arithmetic or MUL in E, away from all clock edges. GPRs do not reset;
  ...
  always @(posedge clk) begin
    ...
    if (!reset && !reset_done && reset_pc>=0 && dut.rvpipe.dp.ValidE &&
        (dut.rvpipe.dp.QDotE || dut.rvpipe.dp.MulE || dut.rvpipe.dp.PackedE) &&
        dut.rvpipe.dp.PCE==32'(reset_pc)) begin
      reset=1; reset_done=1;
      #1;
      if (dut.rvpipe.dp.QDotE !== 0 || dut.rvpipe.dp.MulE !== 0 || dut.rvpipe.dp.PackedE !== 0 ||
          retire !== 0 || we !== 0 || fault !== 0)
